...
if (isset($_POST['user_id']) AND isset($_POST['comment']) AND isset($_POST['shop_id']) AND isset($_POST['product_configuration_id']))
{
	...
	{
		$user_connected->setSelection($shop_displayed->getShopId(), $product_configuration_displayed->getProductConfigurationId(), $_POST['comment']);
